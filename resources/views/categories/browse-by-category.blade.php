                                ...
                                <li class="border p-[6px] border-gray-100/50 rounded group/joblist dark:border-gray-100/20">
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ route('categories.index', ['slug' => $popular_category->slug]) }}" class="text-gray-900 ltr:ml-2 rtl:mr-2 dark:text-gray-50">
                                            <h6 class="font-semibold mb-0 transition-all duration-300 fs-14 group-data-[theme-color=violet]:group-hover/joblist:text-violet-500 group-data- group-data-[theme-color=blue]:group-hover/joblist:text-blue-500">{{ $popular_category->name }}</h6>
                                        </a>
                                    </div>
                                </li>

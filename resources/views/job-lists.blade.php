                ...
                <div class="grid grid-cols-12 gap-y-10 lg:gap-10">
                    <div class="col-span-12 xl:col-span-9 pb-12">
                        <div class="job-list-header">
                            <form action="{{ route('jobs.search') }}" method="GET" class="filter-form">
                                <div class="grid grid-cols-12 gap-3">
                                    ...
                                    <!--end col-->
                                    <div class="col-span-12 xl:col-span-4">
                                        <button class="w-full text-white border-transparent btn group-data-[theme-color=violet]:bg-violet-500 group-data-[theme-color=sky]:bg-sky-500 group-data-[theme-color=red]:bg-red-500 group-data-[theme-color=green]:bg-green-500 group-data-[theme-color=pink]:bg-pink-500 group-data-[theme-color=blue]:bg-blue-500 focus:ring focus:ring-custom-500/30" id="filter-button"><i class="uil uil-filter"></i> Filter Job</button>
                                    </div>
                                    <!--end col-->
                                </div>
                                <!--end grid-->
                        ...
                        <div class="mt-8">
                            <h6 class="font-semibold mb-4 text-gray-900 dark:text-gray-50">Popular Categories</h6>
                    ...
                    <div class="col-span-12 space-y-5 lg:col-span-3 filter_form">

                                    ...
                                    <div class="col-span-12 rounded-b-md lg:col-span-6 group-data-[theme-color=violet]:bg-violet-700 group-data-[theme-color=sky]:bg-sky-700 group-data-[theme-color=red]:bg-red-700 group-data-[theme-color=green]:bg-green-700 group-data-[theme-color=pink]:bg-pink-700 group-data-[theme-color=blue]:bg-blue-700 lg:rounded-b-none lg:ltr:rounded-r-lg rtl:rounded-l-lg">
                                        <div class="flex flex-col justify-center h-full p-12">
                                            <div class="text-center">
                                                ...
                                                <p class="my-3 text-gray-50">Sign Up and get access to all the features of {{config('app.name')}}</p>
                                            </div>
                                            <form action="{{ route('company.register') }}" method="POST">
                                                @csrf
                                                <div class="my-5">
                                                    <label for="name" class="text-white">Company Name</label>
                                                    <input type="text" name="name"  class="w-full mt-1 group-data-[theme-color=violet]:bg-violet-400/40  py-2.5 rounded border-transparent placeholder:text-sm placeholder:text-gray-50 text-white" required="" id="name" placeholder="Enter your email" value="{{old('name')}}">
                                                    @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="mb-5">
                                                    <label for="email" class="text-white">Email</label>
                                                    <input type="email" name="email" class="w-full mt-1 group-data-[theme-color=violet]:bg-violet-400/40  py-2.5 rounded border-transparent placeholder:text-sm placeholder:text-gray-50 text-white" required="" id="email" placeholder="Enter your email" value="{{old('email')}}">
                                                ...
                                                <div class="mb-5">
                                                    <label for="website" class="text-white">Website/LinkedIn Page</label>
                                                    <input type="url" name="website" class="w-full mt-1 group-data-[theme-color=violet]:bg-violet-400/40  py-2.5 rounded border-transparent placeholder:text-sm placeholder:text-gray-50 text-white" id="website" placeholder="Enter your website" value="{{old('website')}}">
                                                    @error('website') <span class="text-danger">{{ $message }}</span> @enderror 
                                                </div>

                                                <div class="mb-5">
                                                    <label for="password" class="text-white">Password</label>
                                                    <input type="password" name="password" class="w-full mt-1 group-data-[theme-color=violet]:bg-violet-400/40  py-2.5 rounded border-transparent placeholder:text-sm placeholder:text-gray-50 text-white" required="" id="password" placeholder="Enter your password">
                                                    @error('password') <span class="text-danger">{{ $message }}</span> @enderror                                                </div>

                                                <div class="mb-5">
                                                    <label for="password_confirmation" class="text-white">Confirm Password</label>                                          <input type="password" name="password_confirmation" class="w-full mt-1 group-data-[theme-color=violet]:bg-violet-400/40  py-2.5 rounded border-transparent placeholder:text-sm placeholder:text-gray-50 text-white" required="" id="password_confirmation" placeholder="Enter your password">
                                            ...
                                            <div class="text-center">
                                                <p class="text-white">Already a member ? <a href="" class="text-white underline fw-medium"> Sign In </a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

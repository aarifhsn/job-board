        ...
        <div class="grid grid-cols-12 gap-y-10 lg:gap-10">
                        ...
                        <div class="grid grid-cols-12 mt-8 gap-y-3 lg:gap-3">
                            ...
                            <div class="col-span-12 lg:col-span-3">
                                <div class="p-4 border rounded border-gray-100/50 dark:border-neutral-600/80">
                                    ...
                                    <p class="font-medium text-gray-900 dark:text-gray-50">Minimum {{$job->experience}}
                                        Year</p>
                                </div>
                            </div>
                            <div class="col-span-12 lg:col-span-3">
            ...
            <div class="col-span-12 space-y-6 lg:col-span-4">
                                ...
                                <li class="mt-3">
                                    <div class="flex">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3">
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-300">{{$job->company->email}}
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="mt-3">
                                    <div class="flex">
                                        ...
                                        <div class="ltr:ml-3 rtl:mr-3">
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-300">{{$job->company->city}},
                                                {{$job->company->country}}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="mt-4">
                    ...
                    <iframe src="https://www.google.com/maps?q={{ urlencode($job->location) }}&output=embed"" style="

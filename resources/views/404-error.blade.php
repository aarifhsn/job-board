...
<!-- Mirrored from themesdesign.in/jobcy-tailwind/layout/404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2025 03:59:52 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <div class="col-span-12 lg:col-span-6 lg:col-start-4">
                                <div class="text-center">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <div class="mt-8">
                                            <a class="text-white border-transparent btn group-data-[theme-color=violet]:bg-violet-500 group-data-[theme-color=sky]:bg-sky-500 group-data-[theme-color=red]:bg-red-500 group-data-[theme-color=green]:bg-green-500 group-data-[theme-color=pink]:bg-pink-500 group-data-[theme-color=blue]:bg-blue-500" href="index.html"><i class="mdi mdi-home"></i> Back to Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from themesdesign.in/jobcy-tailwind/layout/404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2025 03:59:53 GMT -->
</html>
